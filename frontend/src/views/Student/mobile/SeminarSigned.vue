...
<div class="student" style="height:800px;background:#eee;">
    ...
    <div style="font-size:18px;background:#eee"><cell primary="content" title="主题：" value-align="left"><div style="padding-left:30px;color:#000;">&emsp;&emsp;&emsp;领域模型</div></cell></div>
    ...
    <div style="font-size:18px;background:#fff">
        ...
        <div style="padding-left:65px;color:#000;">已报名<span @click="alter" style="text-decoration:underline;padding-left:15px;font-size:0.8em;color:#FF3333">修改</span></div>
        </cell>
        <cell style="height:30px" primary="content" title="课程情况：" value-align="left">
        <div style="padding-left:65px;color:#000;">已完成<span @click="state" style="text-decoration:underline;padding-left:15px;font-size:0.8em;color:#00DB00">成绩排名</span></div>
        </cell>
    </div>

    <div style="font-size:15px;background:#fff;margin-top:10px">
        <cell style="height:20px" primary="content" title="PPT：" value-align="left">
        <div style="padding-left:100px;color:#00DB00;">已提交</div></cell>
        <cell style="height:20px" primary="content" title="书面报告：" value-align="left">
        <div style="padding-left:65px;color:#FF3333;">未提交</div></cell>
    </div>
...
import {XHeader,
        XButton,GroupTitle,Cell,Picker,TransferDom,Popup,Confirm,Flexbox,FlexboxItem
        } from 'vux'
  export default {
    directives:{
        TransferDom
    ...
    components:{
        ...
        XButton,
        GroupTitle,
        Cell,Popup,Confirm,Flexbox,FlexboxItem
    },
    data() {
       return{ 
        show:false,
