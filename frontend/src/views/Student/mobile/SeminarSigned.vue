...
<div class="student" style="height:800px;background:#eee;">
    ...
    <div style="font-size:18px;background:#fff">
        ...
        <div style="padding-left:65px;color:#000;">已报名<span @click="sign" style="text-decoration:underline;padding-left:15px;font-size:0.8em;color:#FF3333">修改</span></div>
        </cell>
    </div>
    ...
    <cell primary="content" title="" value-align="left">
        <div style="padding-left:130px;padding-top:5px;color:#fff;font-weight:520;">PPT提交</div>
        </cell>
    </div>
    <div style="font-size:22px;background:#53FF53;margin-top:10px;height:60px">
    <cell primary="content" title="" value-align="left">
        <div style="padding-left:105px;padding-top:5px;color:#fff;font-weight:520;">书面报告提交</div>
        </cell>
    </div>
    <div v-transfer-dom>
