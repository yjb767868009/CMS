...
public class TeamDao {
    ...
    public List<Team> getSimpleTeamInShareCourse(BigInteger mainCourseId, BigInteger courseId) {
        return teamMapper.getSimpleTeamInShareCourse(mainCourseId, courseId);
    }
}
