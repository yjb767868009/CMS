...
public interface KlassMapper {
     ...
     * @return 插入学生成功信息
     */
    Integer addStudent(@Param("courseId") Integer courseId,
                       @Param("kassId") Integer klassId,
     ...
     * @return 班级列表
     */
    List<Klass> getKlassesInCourse(@Param("courseId") Integer courseId);
     ...
     * @return 删除信息
     */
    Integer deleteKlassRound(@Param("kassId") Integer klassId,
     ...
     * @return 删除信息
     */
    Integer deleteKlassStudent(@Param("kassId") Integer klassId);
}
