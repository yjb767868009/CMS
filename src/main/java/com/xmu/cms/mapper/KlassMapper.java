...
public interface KlassMapper {
     ...
     * @return 班级对象
     */
    Klass getKlassByKlassId(@Param("kassId") BigInteger klassId);//todo
     ...
     * @return 插入学生成功信息
     */
    Integer addStudent(BigInteger courseId, BigInteger klassId, Student student);//todo
     ...
     * @return 班级列表
     */
    List<Klass> getKlassesInCourse(BigInteger courseId);//todo
     ...
     * @return 删除信息
     */
    Integer deleteKlassRound(BigInteger klassId, BigInteger roundId);//todo
     ...
     * @return 删除信息
     */
    Integer deleteKlassStudent(BigInteger klassId);//todo
