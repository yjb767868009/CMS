...
public interface RoundMapper {
     ...
     * @return Round的信息
     */
    Round getRoundByRoundId(@Param("roundId") Integer roundId);
     ...
     * @return 删除信息
     */
    Integer deleteRoundByRoundId(@Param("roundId") Integer roundId);
     ...
     * @return 删除信息
     */
    Integer deleteRoundScore(@Param("roundId") Integer roundId);
}
